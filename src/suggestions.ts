// Editor-friendly prompt library — copied 1:1 from the Premiere extension.
// Powers the empty-state suggestion chips (and, later, ghost autocomplete).
// Each entry: [label, prompt, category].
...
export const POPULAR_LABELS = [
  'Caption pop', 'Word-by-word', 'Lower third', '3s logo intro', 'Title card',
  'End card', 'Subscribe pop', 'Highlight marker', 'Stat counter', 'Quote card',
  'iMessage bubble', 'Versus card',
];
